...
def register_user(email: str, password: str) -> None:
    """
    Test for register user with given email and password.
    Args:
...
def log_in(email: str, password: str) -> str:
    """
    Test for log in with given correct email and password.
    Args:
        email: The email of the user.
        password: The password of the user.
    Returns:
...
def log_out(session_id: str) -> None:
    """
    Test for log out with given session_id.
    Args:
        session_id: The session_id of the user.
    Returns:
        None
...
def reset_password_token(email: str) -> str:
    """
    Test for reset password token with given email.
    Args:
        email: The email of user.
    Returns:
        The reset_token of user.
    """
...
def update_password(email: str, reset_token: str,
    ...
    """
    Test for update password with given email,
    reset_token and new_password.
    Args:
        email: The email of user.
        reset_token: The reset_token of user.
        new_password: The new password of user.
    Returns:
        None
    """
