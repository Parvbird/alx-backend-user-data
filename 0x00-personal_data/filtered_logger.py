#!/usr/bin/env python3
"""
Defined filter_datum function which returns an obfuscated log message
"""
...
def filter_datum(fields: List[str], redaction: str,
    ...
    Args:
        field (list): list of strings indicating fields to obfuscate
